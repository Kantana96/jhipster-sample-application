...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.mycompany.simple_project.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.mycompany.simple_project.security.DomainUserDetailsService", "createSpringSecurityUser");
